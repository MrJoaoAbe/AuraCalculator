      ...
      <div className="bg-[#2D1859] h-full ">
        ...
        <div className="bg-[#1A1040] flex flex-col items-center justify-center h-full p-5 lg:grid lg:grid-cols-5 lg:pt-15">
          <div className='lg:col-start-2 col-span-2 lg:flex lg:flex-col lg:gap-15'>
            ...
            <p className="flex items-center justify-center p-3 mt-5 text-white font-semibold lg:text-xl">Aura é o impacto emocional e simbólico que um personagem exerce sobre os outros — um “campo invisível” de presença, mistério ou poder, criado pela combinação de narrativa, estética e comportamento.</p>
